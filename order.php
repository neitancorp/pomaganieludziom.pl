        ...
        <div class="success-page__header">
            <div class="success-page__header-wrapper">
                ...
                <h2 class="success-page__title">
                    <span>$name</span>, dziękujemy za złożenie zamówienia!
                </h2>
            </div>
        </div>
        <div class="success-page__body">
            <div class="success-page__body-wrapper">
                <h3 class="success-page__text" style="text-align: center">Dziękuję, informacje zapisane.</h3>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="success-page__header-wrapper">
                ...
                <h2 class="success-page__title">
                    ...
                    <p class="success-page__message_success">
                        ...
                        <br>
                        Paczka jest już niemal w drodze do Ciebie. Upewnij się, że Twój numer telefonu jest poprawny i odbierz telefon od naszego managera, by potwierdzić szczegóły.
                    </p>
            </div>
        </div>
        <div class="success-page__body">
            <div class="success-page__body-wrapper">
                <h3 class="success-page__text">Prosimy sprawdzić swoje dane kontaktowe:</h3>
                <div class="list-info">
                ...
                <p class="success-page__message_fail">
                    <a class="success-page__message_fail__link" href="javascript:history.back()">
                        Jeśli podano błędne dane, należy wrócić i ponownie wypełnić formularz.
                    </a>
                </p>
                <h3 class="success-page__text" id="lowerH">
                    Aby przyspieszyć proces składania zamówienia, podaj adres dostawy:
                </h3>
                <div class="form">
                    <form action="" class="success-page__form" name="update_form" id="details" method="post">
                        <div class="success-page__form__container">
                            <label for="" class="success-page__form__label">Adres</label>
                            ...
                            <div class="success-page__form__button" onclick="SubmitForm()"> Wyślij </div>
                        </div>
                    </form>
                </div>
            </div>
...
function SubmitForm() {
    ...
    emptyFieldsMsg = "<span style='color: red'>E-mail i/lub adres wymagane!</span>" +
